...
import { markHowToPlaySeen } from "./arena-preferences.js";
...
/** The three cards from BEAN-BLASTERS.md §10.3, in order. */
const HOW_TO_CARDS: readonly HowToCard[] = [
  {
    id: "thumbs",
    icon: TouchAppOutlinedIcon,
    title: "Left thumb moves. Right thumb aims and throws",
    body: "Put a thumb anywhere on the left half to walk, and drag on the right half to aim. Both thumbs work at once, so you can strafe while you throw. On a computer it is WASD to move, the mouse to aim, click to throw and R to refill.",
  },
  {
    id: "lead",
    icon: ShieldOutlinedIcon,
    title: "Beans travel — lead your target. Crates stop them",
    body: "A bean takes about a second to cross the floor, so throw where a barista is going, not where they are. Crates and the roastery walls swallow beans whole, which makes them worth hiding behind.",
  },
  {
    id: "stakes",
    icon: LocalCafeOutlinedIcon,
    title: "2 minutes. Most splashes wins. Fewest buys the coffee ☕",
    body: "Three hearts each. Run out and you take a six-second refill break, then rejoin with two. Nobody is ever knocked out of the round. Just for fun — settle the bill however you like.",
  },
];
...
export const HowToPlayDialog = ({ open, onClose }: HowToPlayDialogProps) => {
  ...
  return (
    <Dialog
      ...
      fullWidth
      maxWidth="sm"
      aria-labelledby="bean-how-to-title"
      slotProps={{
        paper: {
          sx: {
            borderRadius: 4,
              ...
              return (
                <Box
                  ...
                  sx={{
                    ...
                    py: { xs: 4, sm: 5 },
                    textAlign: "center",
                    // Reduced motion swaps the slide for a plain cross-fade.
