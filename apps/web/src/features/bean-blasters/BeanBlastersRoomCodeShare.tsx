...
import { GAME_DISPLAY_NAME, GAME_TAGLINE } from "./arena-contract.js";
  ...
  return (
    ...
    >
      ...
      <Collapse in={showQr} timeout={reducedMotion ? 0 : 260} unmountOnExit>
        <Stack id="bean-room-qr" spacing={1.5} sx={{ mt: 2.5, alignItems: "center" }}>
          {qrError ? (
            ...
            <Box
              ...
              ref={canvasRef}
              role="img"
              aria-label={`QR code that opens Bean Blasters room ${code}`}
              sx={{
